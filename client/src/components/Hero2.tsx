...
import freeSpeechIcon from "./imgs/hero2.png"; // Import the image
      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-6 gradient-text leading-tight">
            Help Ye Speak Freely and Safely
          </h1>
          <p className="text-lg sm:text-xl text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
            We all miss the old kanye but he is helpless against bully cult of
            billioniares.{" "}
          </p>
